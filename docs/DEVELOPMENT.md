...
│   ├── logic/
│   │   └── chat.js        # Бизнес-логика чата
│   └── ui/
│       └── renderers.js   # Функции рендеринга
│
├── src-tauri/              # Tauri приложение (десктоп)
│   ├── src/
│   │   └── main.rs        # Tauri бэкенд (mDNS + WebSocket)
│   ├── capabilities/
...
|------------|------------|----------|
| Сервер (Rust) | 17 тестов | ~85% |
| Клиент (JS) | 198 тестов | helpers.js 100%, chat.js 100%, renderers.js 100% |
